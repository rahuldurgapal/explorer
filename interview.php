...
<body>
    ...
    <?php  
        ...
        <?php } ?>
        <div class="text-box">
            <h1>Preparing for interview <br>for getting your dream job
            </h1>
        </div>
    </section>
    ...
    <section class="about-us">
        <div class="row">
            <div class="about-col">
                <h1>Prepare yourself for interview </h1>
                <p>Learn how to present your knowledge</p>
                <iframe width="560" height="315" src="https://www.youtube.com/embed/OLVUrgQ_BbA?si=dtCK0PibSPoWJ_uI"
                    title="YouTube video player" frameborder="0"
                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                    allowfullscreen></iframe>
                <iframe width="560" height="315" src="https://www.youtube.com/embed/otkpUBKqCCQ?si=VPRlk0q9qmrLRMzE"
                    title="YouTube video player" frameborder="0"
                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                    allowfullscreen></iframe>
            </div>
